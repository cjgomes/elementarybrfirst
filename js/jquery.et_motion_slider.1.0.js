(function($){
	$.fn.et_motion_slider = function(user_options){
		var defaults = 
		{
			...
			slides: '> div',
			autoSliderSpeed: 5000, // automatic slider speed
			auto: false,
			pauseOnHover: false,
			...
			slideTransitionSpeed: 800, // animations speed
			elementsTransitionSpeed: 800, // start and end animation ( offsets ) speed
			elementsOffset: 0, // start animation offset
			backOffset: 0, // end animation offset
			opacityOffset: 800, // increase the value if you want more "fading"
			transtionEasing: 'easeInCirc', // start (main) animation easing
			transtionEndEasing: 'easeInCirc', // end (main) animation easing
