...
<?php foreach((get_the_category()) as $category) { 
    echo '<a href="http://elementaryosbr.org/apps/" title="Veja outros recursos do sistema" ' . '>' . '<img src="http://elementaryosbr.org/wp-content/themes/elementary/images/' . $category->cat_ID . '.png" alt="' . $category->cat_name . '" />' . '</a>'; 
} 
?></div> 
