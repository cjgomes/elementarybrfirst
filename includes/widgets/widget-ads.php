...
{
    function AdvWidget(){
		$widget_ops = array('description' => 'Exibe banners personalizados');
		$control_ops = array('width' => 400, 'height' => 500);
		parent::WP_Widget(false,$name='Publicidade',$widget_ops,$control_ops);
	}
...
<?php
  ...
  /*Creates the form for the widget in the back-end. */
    function form($instance){
		...
		<label for="<?php echo $this->get_field_id('new_window'); ?>">Abrir em nova janela</label><br /><br />
		...
		echo '<p><small>Se você não quer exibir algum banner, deixe o campo em branco.</small></p>';
	}
