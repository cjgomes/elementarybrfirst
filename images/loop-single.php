...
<?php $googleplus = get_the_author_meta('googleplus'); if ($googleplus) { ?><a href="<?php the_author_meta('googleplus'); ?>?rel=author" class="author" itemprop="creator" itemscope itemtype="http://schema.org/CreativeWork" title="Siga o perfil de <?php the_author(); ?> no Google+" target="_blank">Google+</a><?php } else { ?><?php the_author(); ?><?php } ?><br />
